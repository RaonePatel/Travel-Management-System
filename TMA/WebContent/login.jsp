		...
		<div class="container">
			<div class="login">
				...
				<form method="post" action="Login" name="index">
					<input type="text" name="emailId" placeholder="Email-ID" required="required" class="input-txt" value="khush@gmail.com"/>
					<input type="password" name="password" placeholder="Password" required="required" class="input-txt" value="khushpass"/>
