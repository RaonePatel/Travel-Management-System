...
<body>
<input type="button" class="btn btn--right shift--left" name="home" value="Home" onclick="location.href = 'Airline.jsp';">
<br/><br/><br/>
...
<body>
	<div  class="form">
            ...
            <form id="contactform" method="post" action="ReadData">
                ...
                <input id="per_id" name="p_id" placeholder="Personal ID" required tabindex="1" type="text" value="<%=array[0]%>">
                ...
                <textarea id="add" cols="30" rows="5" name="address" placeholder="Type your Permanant Address" required tabindex="1"><%=array[4] %></textarea>
